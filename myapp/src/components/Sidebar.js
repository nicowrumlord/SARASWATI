...
const SideBar = () => {
    // log out function removes the tokenb and uses navigate to get to the login page  
        ...
        <aside className=" lg:w-80 rounded bg-sky-100" aria-label="Sidebar">
            <div className="overflow-y-auto py-4 px-3 rounded bg-sky-100">
                <ul className='space-y-2'>
                    ...
                    <li>
                        <a href="" className="flex items-center p-2 text-base font-bold text-stone-900 rounded-lg dark:text-white hover:bg-red-500 dark:hover:bg-red-500" >
